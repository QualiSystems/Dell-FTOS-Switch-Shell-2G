...
from ftos.autoload.snmp_if_port_channel_entity import SnmpIfPortChannelEntity
from ftos.autoload.snmp_if_port_entity import SnmpIfPortEntity
from ftos.autoload.snmp_port_attr_tables import SnmpPortAttrTables
