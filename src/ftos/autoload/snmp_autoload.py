...
from cloudshell.devices.standards.networking.autoload_structure import GenericResource, GenericModule, GenericSubModule, \
    GenericPowerPort, GenericPortChannel, GenericPort, GenericChassis
...
from ftos.autoload.snmp_entity_table import SNMPEntityTable
from ftos.autoload.snmp_if_table import SnmpIfTable
